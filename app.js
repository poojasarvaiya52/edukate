...
const userpaths = [
  ...
  { pathUrl: '/content', routeFile: 'content' },
  { pathUrl: '/detail', routeFile: 'detail' },
  { pathUrl: '/css', routeFile: 'css' },
  { pathUrl: '/java', routeFile: 'java' },
  { pathUrl: '/ios', routeFile: 'ios' },
  { pathUrl: '/oops', routeFile: 'oops' },
  { pathUrl: '/cpp', routeFile: 'cpp' },
